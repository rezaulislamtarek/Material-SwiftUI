...
public struct MSPicker: View {
    ...
    struct MSPicker_Previews: PreviewProvider {
        
        static var previews: some View {
            MSPicker(text: .constant(""), placeHolder: "Enter text", color: Color.white, cornerRadious: 10.0)
